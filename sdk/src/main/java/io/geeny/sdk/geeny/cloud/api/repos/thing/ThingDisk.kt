...
object ThingJsonConverter : JSONConverter<CloudThingInfo> {
    ...
    override fun id(value: CloudThingInfo): String = value.serial_number

    override fun fromJSON(json: JSONObject): CloudThingInfo =
            CloudThingInfo(
    ...
    override fun toJSON(value: CloudThingInfo): JSONObject =
            JSONObject().apply {
