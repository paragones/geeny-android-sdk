...
class DetailConnectionLayout : LinearLayout, DetailConnectionView {
    override fun back() {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }

    private var presenter: DetailConnectionPresenter? = null
    ...
    fun connect(address: String) {
        ...
        presenter = DetailConnectionPresenter(address,
                app.component.sdk,
