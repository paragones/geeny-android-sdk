    ...
    val sdk: GeenySdk by lazy {
        ...
        val config =
                GeenyConfiguration.Builder()
                        ...
                        .withSlot(AppConfig.DISCO_SOURCE_RESOURCE_ID, DiscoSource(AppConfig.DISCO_SOURCE_RESOURCE_ID, 1000, "Disco",0, 1))
                        .withSlot(AppConfig.DANCE_SOURCE_RESOURCE_ID, DiscoSource(AppConfig.DANCE_SOURCE_RESOURCE_ID, 1000, "Dance", 48, 49))
